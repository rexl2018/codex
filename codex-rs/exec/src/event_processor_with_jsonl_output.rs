...
use crate::exec_events::TaskStartedEvent;
...
impl EventProcessorWithJsonOutput {
    ...
    pub fn collect_thread_events(&mut self, event: &protocol::Event) -> Vec<ThreadEvent> {
        match &event.msg {
            ...
            protocol::EventMsg::TaskStarted(ev) => self.handle_task_started(ev),
            protocol::EventMsg::TaskComplete(_) => self.handle_task_complete(),
    ...
    fn handle_task_started(&mut self, _: &protocol::TaskStartedEvent) -> Vec<ThreadEvent> {
        self.last_critical_error = None;
        vec![ThreadEvent::TurnStarted(TaskStartedEvent {})]
    }
...
impl EventProcessor for EventProcessorWithJsonOutput {
    ...
    fn process_event(&mut self, event: protocol::Event) -> CodexStatus {
        ...
        if let protocol::EventMsg::TaskComplete(protocol::TaskCompleteEvent {
            last_agent_message,
        }) = msg
        {
